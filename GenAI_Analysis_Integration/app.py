...
from rag_code import InvestmentPortfolioDB, CustomLLM
...
def initialize_workflow(documents, dataframe, llm_name, collection_name):
    with st.spinner("Loading documents and initializing the workflow..."):
        ...
        document_text = "AI Market Growth Surpasses Expectations The global AI market is projected to reach $1.3 trillion by 2030, growing at a CAGR of 35%. This remarkable growth is driven by increased enterprise adoption, advancements in generative AI, and AI integration across multiple industries such as healthcare, finance, and automation. With AI becoming a core part of business strategies, companies are heavily investing in cutting-edge technologies to stay ahead in the competitive landscape. NVIDIA's AI Dominance Continues NVIDIA remains the undisputed leader in AI hardware, with its latest Blackwell architecture chips being rapidly adopted by cloud providers and enterprises. The demand for high-performance AI computing has led to record-breaking sales, boosting NVIDIA's stock price by 20% in Q1 2025. Industry experts predict that NVIDIA's advancements in AI GPUs will continue to drive the market, setting new benchmarks for machine learning and deep learning applications. Investment in AI Startups Hits New High Venture capital investment in AI startups reached an all-time high, with over $15 billion secured in Q1 2025. Key investors are backing companies focused on Artificial General Intelligence (AGI), multimodal models, AI-driven robotics, and autonomous systems. OpenAI, Anthropic, and emerging players are among the major beneficiaries, pushing AI innovation to new frontiers. Experts believe that AI startups will play a crucial role in shaping the future of AI-driven automation and intelligent applications. AI in Healthcare Revolutionizing Medical Diagnosis The healthcare sector is witnessing a transformative shift with AI-driven diagnostic tools revolutionizing patient care. AI models now assist in detecting diseases such as cancer, predicting patient deterioration, and personalizing treatment plans. Companies like Google DeepMind and IBM Watson are leading this change, making healthcare more accessible and efficient. Experts anticipate that AI adoption in medicine will save millions of lives and reduce medical costs globally."
        ...
        chatbot_instance = CustomLLM()  # Assuming CustomChatbot has `chatbot_tool` method
        chatbotTool = Tool(
            name="chatbotTool",
      ...
      try:
          ...
          for uploaded_file in uploaded_files:
              ...
              if file_type in ["pdf", "docx", "txt"]:
                  # st.write("📄 Storing in Qdrant Vector Database")
